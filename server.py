...
def disconnectWithClient(message, client, client_name):
    ...
    if enteredClientName in clients:
        ...
        greetMessage = f'Hello, {enteredClientName}, you are successfully disconnected with {client_name}.'
...
def connectClient(message, client, client_name):
    ...
    if enteredClientName in clients:
        if not clients[client_name]['connected_with']:
            ...
            otherClientSocket = clients[enteredClientName]['client']
            greetMessage = f'Hello, {enteredClientName}! {client_name} connected with you.'
            otherClientSocket.send(greetMessage.encode())
